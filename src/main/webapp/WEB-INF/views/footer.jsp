...
<title>Online Site for all your delicious desserts needs - SweetGene.com</title>
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-6 footer-contacts">
			    ...
			    <div><i class="fa fa-phone footer-contacts-icon"></i>
			        <p class="footer-center-info email text-left"> 1800-123-123</p>
			    </div>
			    <div><i class="fa fa-envelope footer-contacts-icon"></i>
			        <p> <a href="#" target="_blank"></a> sweetgene@gmail.com</p>
			    </div>
			</div>
